...
def video_dash():
    ...
    # Altair Plot
    df_altair = pd.read_csv('static/js/db/prob.csv',
...
def audio_dash():
    ...
    SER.prediction_to_csv(emotions, os.path.join(
        "static/js/db", "audio_emotions_other.txt"), mode='a')
    ...
    df_other = pd.read_csv(os.path.join(
        "static/js/db", "audio_emotions_other.txt"), sep=",")
    ...
    df_other.to_csv(os.path.join(
        'static/js/db', 'audio_emotions_dist_other.txt'), sep=',')
...
def text_1():
    ...
    # Create a new DataFrame from probas
    ...
    df_words_co = pd.read_csv(
        'static/js/db/words_common.txt', sep=',')
    ...
    df_words_perso = pd.read_csv(
        'static/js/db/words_perso.txt', sep=',')
